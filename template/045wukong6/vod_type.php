        ...
        <div id="app" class="mt10">
            <div class="video-filter">
                <dl>
                    ...
                    <dd>
        {video_menu} <a href="{menu_link}" class="btn btn-sm btn-primary">{menu_name}</a>{/video_menu}
                    </dd>
                </dl>
				<dl>
				            <dt>
				            ...
				            <dd>
				{hd_menu} <a href="{menu_link}" class="btn btn-sm btn-primary">{menu_name}</a>{/hd_menu}
				            </dd>
				        </dl>
            </div>
