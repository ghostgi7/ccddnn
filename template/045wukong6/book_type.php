        ...
        <div id="app" class="mt10">
            <div class="video-filter">
                <dl>
                    ...
                    <dd>
        {book_menu} <a href="{menu_link}" class="btn btn-sm btn-primary">{menu_name}</a>{/book_menu}
                    </dd>
                </dl>
            </div>
    ...
    <li class="video-item space-sm">
        <div class="white">
            <div class="video-thumb">
                <div
                        data-original="{cms_template}/static/image/novel_nopic.png@2x.png"
                        data-picthumb="{cms_template}/static/image/novel_nopic.png@2x.png"
