function set_cookie(t, e, o, n) {
    ...
    for (a in t) document.cookie = a + "=" + t[a] + i + "; domain=" + (o || "maomi.com") + "; path=" + (n || "/")
}
...
function changeTheme(themeValue) {
    let theme = "../assets/css/theme/" + themeValue + ".css"
...
function imgError(flag, e) {
    let src = "assets/images/default/nodata/248x355.jpg";
    switch (flag) {
        case 1:
            src = "assets/images/default/nodata/980x70.jpg";
            break;
        case 2:
            src = "assets/images/default/nodata/400x400.jpg";
            break;
    }
    e.src = src;
    //控制不要一直跳动
...
function setTTjs(selector) {
    ...
    newscript.setAttribute('src', '/assets/js/common/tt.js');
