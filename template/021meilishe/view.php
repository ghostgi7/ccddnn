...
<head>
    ...
    <title>{cmsobj_name} - 高清视频在线观看 - {cms_title}</title>
    <meta name="description" content="{cmsobj_name} - 高清视频在线观看 - {cms_title}" />
    <meta name="keywords" content="{cmsobj_name} - 高清视频在线观看 - {cms_title}" />
...
{cmsobj_content}
                            ...
                            <div class="single-video-title box mb-3">
                                <h2><a>{cmsobj_name}</a></h2>
                                <p class="mb-0"><i class="fas fa-eye"></i> <span class="mac_hits hits" data-mid="" data-id="" data-type="hits"></span>   {list_hit} </p>
                            </div>
                            {cms_banner_b}
                        </div>
                    </div>
