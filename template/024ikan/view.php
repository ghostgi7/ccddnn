            ...
            <div class="play_box_right">
                ...
                <div class="play_infobox">
                    <div class="play_vlist cblock">
                        <div class="play_vlist_thumb vnow lazyload" data-original="{cmsobj_pic}"
                             style="background-image: url(&quot;{cmsobj_pic}&quot;);"></div>
                        <div class="play_vlist_text vnow">
                            <p class="play_vlist_title">{cmsobj_name}</p>
                            <p class="play_vlist_now"><a href="{cmsobj_view}"><i class="iconfont"></i>&nbsp;切换线路</a></p>
                        </div>
                    </div>
