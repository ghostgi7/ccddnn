...
var ikan = {
	...
	swiper: function() {
		$.getScript(smcms.tpl + "/static/js/swiper.min.js", function() {
	...
	wrapper: function() {
		var windowWidth = $(window).width();
		if (windowWidth < 820) {
		$.getScript(smcms.tpl + "/static/js/iscroll.js", function() {
	...
	images: {
		lazyload: function() {
			$.getScript(smcms.tpl + "/static/js/jquery.lazyload.min.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 20,
		...
		qrcode: function() {
			$.getScript(smcms.tpl + "/static/js/jquery.qrcode.min.js", function() {
				$(".cans").qrcode({
					width:120,
					height:120,
	...
	copy: function() {
		$.getScript(smcms.tpl + "/static/js/clipboard.min.js", function() {
