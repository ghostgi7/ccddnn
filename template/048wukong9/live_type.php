...
<ul>
{live_list:20}
<li class="multi cate2 auth1"><div class="cateimg"><a href="{list_view}" data-type="mip" data-title="{list_name}" title="{list_name}"><mip-img layout="container" class="media-object" alt='{list_name}' src="{list_pic}"></mip-img><div class="zoomimg"></div></a></div><div class="catename"><a href="{list_view}" data-type="mip" data-title="{list_name}" title="{list_name}">{list_name}</a></div><div class="cateinfo"><span class="icoplay">{list_hit}次播放</span></div></li>{/live_list}
