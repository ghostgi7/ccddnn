...
<body>
		...
		<div id="dtextlink" class="wrap border-gray fn-clear">
		  ...
		  <strong>您所在的位置：</strong><a>{cmsobj_typename}</a>&nbsp;>&nbsp;<a>{cmsobj_name}</a>&nbsp;>&nbsp;<a>视频介绍</a></div>
		</div>		
            <div  class="border-gray clearfix">
               <div class="detail-pic" style="display: block;"> <img src="{cmsobj_pic}" alt="{cmsobj_time}"> </div>
               <div class="detail-info fn-left">
                  <div class="detail-title fn-clear">
                     <h2 style="margin-top:0px;">{cmsobj_name}</h2>
                  </div>
                  <div class="info fn-clear">
                     <dl>
                           <dl class="fn-right">
                            <dd>分类：<a>{cmsobj_typename}</a></dd>
                        </dl>
                        <dl class="fn-left">
                           <dd>时间：<span id="addtime">{cmsobj_time}</span></dd>
                        </dl>
	 ...
	 <div class="ui-box border-gray clearfix">
				...
				<div class="layout-box clearfix">
					<div class="box-title">
						<h3 class="m-0"><i class="icon iconfont text-color"></i>猜你喜欢</h3>
					</div>
					<ul class="clearfix">
						{video_list:12}
